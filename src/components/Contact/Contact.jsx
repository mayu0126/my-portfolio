...
const Contact = ({id}) => {
  ...
  return(
    <div id={id} className='flex justify-center items-center h-screen bg-slate-900'>
      <div className='-mt-36 w-5/6 sm:w-4/6 md:w-1/2 lg:w-1/3 px-2 py-2 text-slate-900'>
        <div className='text-center'>
          <div className='mb-10 font-bold text-2xl md:text-3xl xl:text-4xl text-amber-100'>CONTACT</div>
