...
const Experience = ({id}) => {
  ...
  return(
    <div id={id} className={`${isNarrowScreen ? "flex-col" : "h-screen"} flex justify-center items-center h-screen bg-slate-100`}>

      <div className={`${isNarrowScreen ? "hidden" : "h-fit w-1/3 -mt-24 mr-20"}`}>
      ...
      <div className='mt-10 xl:-mt-36 w-2/3 md:w-1/2 lg:w-1/3 px-2 py-2 xl:mr-20 text-slate-900'>
